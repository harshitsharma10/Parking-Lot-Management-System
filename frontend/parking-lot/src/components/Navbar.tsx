...
const userLinks = [
  ...
  { to: '/dynamic-entry', label: 'Dynamic Park' },
  { to: '/queue-entry', label: 'Queue Park' },
    ...
    <nav className="bg-[#0f0f0f] border-b border-white/10 px-6 py-4 flex items-center justify-between sticky top-0 z-50">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="text-white/20 hover:text-white/60 text-xs font-mono tracking-widest uppercase
